...
@testset "FASTA Module Tests" begin
    ...
    @testset "digest_sequence N-terminal Met excision" begin
        ...
        @test all(==(UInt8(2)), ntt)

        # Off (the default for digest_sequence): identical to the historical output.
