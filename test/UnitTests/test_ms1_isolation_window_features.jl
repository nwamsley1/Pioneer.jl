...
@testset "MS1 isolation-window signal features" begin
    ...
    @test Pioneer._ms1_isotope_dotp_m0_m1_m2(100f0, 50f0, 25f0, 4f0, 2f0, 1f0) ≈ 1f0
    @test Pioneer._ms1_isotope_dotp_m0_m1_m2(100f0, 0f0, 0f0, 4f0, 2f0, 1f0) < 0.9f0
    ...
    @test psms.ms1_isotope_dotp_m0_m1_m2 == Float32[0, 0]
    @test !hasproperty(psms, :ms1_isotope_dotp_m0_m1_m2_pc)
    ...
    @test :ms1_isotope_dotp_m0_m1_m2 in Pioneer.PRESCORE_FEATURES
    @test !(:ms1_isotope_dotp_m0_m1_m2_pc in Pioneer.PRESCORE_FEATURES)
    ...
    @test :ms1_isotope_dotp_m0_m1_m2 in Pioneer.ADVANCED_FEATURE_SET
    @test !(:ms1_isotope_dotp_m0_m1_m2_pc in Pioneer.ADVANCED_FEATURE_SET)
end
