...
@testset "Split packages own their runtime without using Pioneer" begin
    ...
    @test !occursin("packages\", \"PioneerSearch\", \"src\", \"owned\", \"GenerateParams.jl", predict_module)
    ...
    @test occursin("save_multipage_pdf(args...; kwargs...) = get_pioneer_plots_module().save_multipage_pdf(args...; kwargs...)", search_module)
    @test occursin("qcPlots(args...; kwargs...) = get_pioneer_plots_module().qcPlots(args...; kwargs...)", search_module)
