...
@testset "empirical fragment reference features use top-2 leave-one-out references" begin
    ...
    scores = Float32[0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.7, 0.9, 0.8, 0.7]
    peps = Float32[0.0, 0.75, 1.0, 1.0, 1.0, 0.0, 0.02, 0.1, 0.2, 0.3]
    frag_cols = (
        Float32[100, 0, 0, 0, 0, 0, 25, 100, 81, 100],
        Float32[0, 100, 100, 100, 100, 100, 25, 0, 19, 0],
