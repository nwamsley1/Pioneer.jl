...
getPartnerPrecursorIdx(lp::LibraryPrecursors)::Arrow.Primitive{Union{Missing, UInt32},Array{UInt32,1}} = lp.data[:partner_precursor_idx]
getPairIdx(lp::LibraryPrecursors) = lp.data[:pair_id]
getPlex(lp::PlexedLibraryPrecursors)::Arrow.Primitive{Union{Missing, UInt32}, Vector{UInt32}}= lp.data[:plex]
