...
"""
    makeRTIndices(temp_folder, psms_paths, prec_to_irt, rt_to_irt_splines; min_prob=0.5)
...
- For unobserved precursors: Falls back to values in prec_to_irt (which contains best_irt from precursor_dict)
