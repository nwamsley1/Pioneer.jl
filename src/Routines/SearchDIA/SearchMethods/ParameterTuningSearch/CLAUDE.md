...
## Algorithm: 2-phase wide scout → collection

The historical "3-phase bias-shift × multi-score × scan-scaling" iteration was replaced by a simpler scout-then-collect flow:
...
| `fit_intensity_mass_error.jl` | Optional `IntensityMassErrorModel` fitting pipeline. |
