...
function get_protein_groups(
    ...
    use_efficient_implementation::Bool = true  # Use new efficient implementation by default
)
    # Use efficient implementation if enabled
    if use_efficient_implementation
        return get_protein_groups_efficient(
            passing_psms_paths,
            passing_pg_paths,
            ...
            protein_q_val_threshold = protein_q_val_threshold,
