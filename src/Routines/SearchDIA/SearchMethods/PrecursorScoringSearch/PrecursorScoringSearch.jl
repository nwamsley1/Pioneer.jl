...
function summarize_results!(
    ...
    step5_10_time = @elapsed begin
        ...
        # MBR Phase 7: no qval bypass. :trace_prob is a hybrid (prepass for
        # non-recovered, MBR-boosted for recovered) so the qval spline above
        # already reflects honest target/decoy competition for recovered rows.
