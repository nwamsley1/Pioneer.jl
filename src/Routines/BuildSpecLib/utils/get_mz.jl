...
const C13_C12_MASS_DIFF::Float64 = 13.00335483507 - 12.0
const C13_C12_MASS_DIFF_F32::Float32 = Float32(C13_C12_MASS_DIFF)
# Compatibility aliases for older callers. Natural peptide isotope spacing
# should use `C13_C12_MASS_DIFF`, not a free-neutron mass.
const NEUTRON::Float64 = C13_C12_MASS_DIFF
const NEUTRON_F32::Float32 = C13_C12_MASS_DIFF_F32
