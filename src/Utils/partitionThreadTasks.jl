...
function partitionScansToThreads2(spectra::Arrow.List{Union{Missing, SubArray{Union{Missing, Float32}, 1, Arrow.Primitive{Union{Missing, Float32}, Vector{Float32}}, Tuple{UnitRange{Int64}}, true}}, Int64, Arrow.Primitive{Union{Missing, Float32}, Vector{Float32}}},
                                rt::Arrow.Primitive{Union{Missing, Float32}, Vector{Float32}},
                                prec_mz::Arrow.Primitive{Union{Missing, Float32}, Vector{Float32}},
                                ms_order::Arrow.Primitive{Union{Missing, Int32}, Vector{Int32}},
                                n_threads::Int,
